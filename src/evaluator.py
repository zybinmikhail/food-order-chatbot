...
def evaluate_scenario(
    ...
    Args:
        ...
        evaluator_model_dict (dict[str, str]): Dictionary with "api_base" abd "model" fields that describe the evaluator LLM
        chatbot_model_dict (dict[str, str]): Dictionary with "api_base" abd "model" fields that describe the chatbot LLM
        analyzer_model_dict (dict[str, str]): Dictionary with "api_base" abd "model" fields that describe the analyzer LLM
        use_provocation (bool, optional): Whether or not the user's reply are generated by provocator LLM or taken from the prepared scenario. Defaults to False.
        provocator_model_dict (Optional[dict[str, str]], optional): Dictionary with "api_base" abd "model" fields that describe the provocator LLM. Defaults to None.
